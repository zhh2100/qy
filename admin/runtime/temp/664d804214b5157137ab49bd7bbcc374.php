<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/www/wwwroot/88.88.88.88/application/index/view/zhibo/add.html";i:1533834268;s:61:"/www/wwwroot/88.88.88.88/application/index/view/layout.html";i:1534156774;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1">
            ...
            <li>
                ...
                <a href="<?php echo url('zhibo/index'); ?>">zhibo</a>
            </li>
            <li class="active">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1"  method="post" action="<?php echo url('zhibo/create'); ?>" enctype="multipart/form-data" class="validate">
            ...
            <div class="form-group">
                <label class="control-label">直播源</label>
