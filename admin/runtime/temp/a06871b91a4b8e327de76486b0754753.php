<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"/www/wwwroot/120.86.156.22:8082/application/index/view/user/xlog.html";i:1540286916;s:62:"/www/wwwroot/120.86.156.22:8082/application/index/view/layout.html";i:1540035824;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
                    ...
                    <form class="validate" method="get" action="<?php echo url('user/xlog'); ?>">
                       操作日期 <br><input class="form-control"  type="date" name="start" >-<input type="date" name="end" class="form-control" >
                        ...
                        <select name="day" class="form-control">
                            ...
                            <option value="0.1"}>七天</option>
                             <option value="0.3"}>一个月</option>
                             <option value="0.6"}>三个月</option>
                             <option value="1.8"}>一年</option>
