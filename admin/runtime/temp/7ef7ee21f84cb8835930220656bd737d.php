<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"/www/wwwroot/120.86.156.22:8082/application/index/view/tv/add.html";i:1533556344;s:62:"/www/wwwroot/120.86.156.22:8082/application/index/view/layout.html";i:1540035824;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1">
            ...
            <li>
                ...
                <a href="<?php echo url('tv/index'); ?>">tv</a>
            </li>
            <li class="active">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1"  method="post" action="<?php echo url('tv/create'); ?>" enctype="multipart/form-data" class="validate">
