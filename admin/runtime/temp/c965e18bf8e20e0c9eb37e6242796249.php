<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"/www/wwwroot/120.86.156.22:8082/application/index/view/user/index.html";i:1540287065;s:62:"/www/wwwroot/120.86.156.22:8082/application/index/view/layout.html";i:1540035824;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<script>
    function btime(id) {
        ...
        layer.open({
            ...
            ' <option value="0.1"}>七天0.5点</option>' +
            ' <option value="0.3"}>一个月1点</option>' +
            ' <option value="0.6"}>三个月2点</option>' +
            ' <option value="1.8"}>一年8点</option>' +
            ' <option value="5"}>永久10点</option>' +
            ' </select>' +
            ' </div>' +
