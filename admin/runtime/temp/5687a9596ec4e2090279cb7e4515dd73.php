<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/wwwroot/app.yuxiaxie888.cn/application/app/view/index/index.html";i:1538943100;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    function down() {
        if (/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {
            //苹果下载地址
            window.location.href ="https://baidu.com";  //这里替换你的下载地址
            $('.warp').hide();
            $('.step').show();
