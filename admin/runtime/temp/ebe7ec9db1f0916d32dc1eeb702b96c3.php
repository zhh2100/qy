<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/www/wwwroot/app.yuxiaxie888.cn/application/index/view/video/index.html";i:1537097420;s:66:"/www/wwwroot/app.yuxiaxie888.cn/application/index/view/layout.html";i:1538650796;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
                    ...
                    <ul>
                      ...
                      <li >
                            <a href="<?php echo url('/index/banner/index/id/8'); ?>">
                                <span class="title">APP首页右上角搜索</span>
                            </a>
                        </li>                      
                      ...
                      <li >
                            <a href="<?php echo url('/index/banner/index/id/6'); ?>">
                                <span class="title">福利页小图标</span>
                            </a>
                        </li>                      
                      
                      <li >
                            <a href="<?php echo url('/index/banner/index/id/7'); ?>">
                                <span class="title">福利页底部广告图</span>
                            </a>
                        </li>                      
