<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/www/wwwroot/app_m6php_cn/application/index/view/tuijian/update.html";i:1533756258;s:60:"/www/wwwroot/app_m6php_cn/application/index/view/layout.html";i:1539851320;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1">
            ...
            <li>
                ...
                <a href="<?php echo url('tuijian/index'); ?>">tuijian</a>
            </li>
            <li class="active">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1"  method="post" action="<?php echo url('tuijian/edit'); ?>" enctype="multipart/form-data" class="validate">
