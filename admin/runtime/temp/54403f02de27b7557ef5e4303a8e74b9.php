<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"/www/wwwroot/88.88.88.88/application/app/view/index/m.html";i:1535555324;}*/ ?>
    ...
    $('.down').click(function(){
        ...
        if(isAndroid)
        {
            ...
            if(weixin){
                ...
                window.location.href="http://downloadpkg.apicloud.com/app/download?path=http://A6080711419022.qiniucdn.apicloud-system.com/9018f095eb4e6e8cd23d42ad4b175c5c_d";
            }
        }else{
