<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"/www/wwwroot/app_m6php_cn/application/index/view/tuijian/add.html";i:1533756220;s:60:"/www/wwwroot/app_m6php_cn/application/index/view/layout.html";i:1539851320;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1"  method="post" action="<?php echo url('tuijian/create'); ?>" enctype="multipart/form-data" class="validate">
