<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"C:\wwwroot\app.m6php.cn/application/app\view\index\index.html";i:1537525313;}*/ ?>
﻿
<!DOCTYPE HTML>
										...
										<div class="header-center-box">
											<div class="header-center-box-content">
													<span class="header-logo">
													 <!-- 图标尺寸一定要100*100尺寸 -->	<img src="images/icon1.png" 
															 class="animated"
															 style="animation-delay:0s;">
													</span>

												<h2 class="light-heading animated"
													style="animation-delay:0.3s;">千月影视
	
												</h2>

												<h5 class="light-heading subhader animated"
													style="animation-delay:0.4s;">杜绝收费·畅看大片
	
												</h5>

												<p  class="animated"
													style="animation-delay:0.5s;">即刻下载，观看全网影视VIP；</br>
                                                                                       免会员﻿用卷电影尽情看。
												...
												<div class="download">
													<img src="http://qr.liantu.com/api.php?text=http://120.86.156.22:8082/" width="112" height="112" alt="" style="position:absolute; left:100px; top:590px; "
														 style="animation-delay:0s;">
													<div class="downloadBtn">
                                                      ...
                                                      <a class="button rounded button-ios animated" style="animation-delay:0.8s;" href="https://jingyan.baidu.com/article/a681b0de09860d3b184346bc.html" >
															IOS未信任教程
														</a>
													</div>
												</div>
										...
										<div class="header-center-box">
											<div class="header-center-box-content">
												<div class="vertical-featured-image-container">
													<img src="images/01.png" alt="" class="animated"
									...
									<div class="col-md-7">
										<div class="header-center-box">
											<div class="header-center-box-content">
												...
												<p
													class="animated"
													style="animation-delay:0.5s;">想追的电影电视剧需要付费观看？</br>
                                                                                   无广告在线云点播，帮你搞定
