<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/www/wwwroot/120.86.156.22:8082/application/index/view/mn/index.html";i:1540033108;s:62:"/www/wwwroot/120.86.156.22:8082/application/index/view/layout.html";i:1540035824;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
            ...
            <div class="panel-body">
                <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk"
                    ...
                    <div class="btn-toolbar">
                      ...
                      <div class="btn-group focus-btn-group">
                          <a href="http://zuidazy.net/?m=vod-type-id-16-pg-6.html" target="view_window">
                                <button class="btn btn-default"><i class=""></i> 最大采集网</button>
                            </a>
							
                        </div>
						<div class="btn-group focus-btn-group">
                          <a href="http://yongjiuzy.net/" target="view_window">
                                <button class="btn btn-default"><i class=""></i> 永久采集网</button>
                            </a>
							
                        </div>
						<div class="btn-group focus-btn-group">
                          <a href="http://www.okzy.me/?m=vod-type-id-22.html" target="view_window">
                                <button class="btn btn-default"><i class=""></i> OK资源网</button>
                            </a>
							
                        </div>
                      <div class="btn-group focus-btn-group" style="color:#FFF">
                          <a href="/wxgzh/cjjc.png" target="view_window">
                                <button class="btn btn-default"><i class=""></i> 采集教程</button>
                            </a>
