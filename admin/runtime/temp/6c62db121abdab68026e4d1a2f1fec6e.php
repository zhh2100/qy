<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/www/wwwroot/88.88.88.88/application/index/view/zhibo/index.html";i:1534152570;s:59:"/www/wwwroot/88.88.88.88/application/index/view/layout.html";i:1534156774;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
  ...
  <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk"
                    ...
                    <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                        ...
                        <tr>
                           ...
                           <th style=" text-align: center;"> <a href="<?php echo url('zhibo/update',['id'=>$vo['id']]); ?>" title="修改" > <i class="el-edit"></i></a>
                               &nbsp;
                               <a href="<?php echo url('zhibo/del',['id'=>$vo['id']]); ?>" title="删除" class=btn-single"><i class="el-trash-circled"></i></a></th>
