<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"/www/wwwroot/app.yuxiaxie888.cn/application/app/view/index/m.html";i:1538942059;}*/ ?>
    ...
    $('.down').click(function(){
        ...
        if(isAndroid)
        {
            ...
            if(weixin){
                ...
                window.location.href="https://fa.xinmeng521.top/app.php/27";
            }
        }else{
          
            window.location.href="http://88.88.88.88/app/index/ios.html";
        }
    });
